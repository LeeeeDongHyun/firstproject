...
public class DebuggingAspect {
    ...
    //대상 메소드 주입 대상 지정 : CommentService#create()
    private void cut() {}

    @Before("cut()")    //대상 실행 이전에 수행(실행 시점 설정): cut()의 대상이 수행되기 이전
    ...
    @AfterReturning(value = "cut()", returning = "returnObj")      //Object를 returning값에 넣어야한다.
